          ...
          <div className="container mx-auto relative z-10">
            <div className="flex flex-col max-w-5xl mx-auto gap-8">
              <div className="relative flex flex-col text-center items-center sm:gap-6 gap-4">
                ...
                >
                  Automatically confirm bookings and send reminders through WhatsApp or email using your Google Calendar. Keep clients informed and reduce missed appointment
                </motion.p>
              </div>
              <motion.div
                initial={{ opacity: 0, y: 32 }}
              ...
              >
                <Button onClick={openLogin} className="relative text-sm font-medium rounded-full h-12 p-1 ps-6 pe-14 group transition-all duration-500 hover:ps-14 hover:pe-6 w-fit overflow-hidden cursor-pointer">
